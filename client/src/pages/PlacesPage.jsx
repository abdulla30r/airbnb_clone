        ...
        <div>
          <form>
            ...
            <p className="text-gray-500 text-sm">
              Title for your place. should be nice and catchy as in
              advertisement
            </p>
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              <button className="flex justify-center gap-1 border bg-transparent rounded-2xl p-8 text-gray-600 text-2xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
